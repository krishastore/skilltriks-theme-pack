...
if ( is_user_logged_in() ) :
	...
	<div class="bdlms-filter-item">
		...
		<div class="bdlms-user-dd__menu" style="display: block;">
			<a href="<?php echo esc_url( \BlueDolphin\Lms\get_page_url( 'my_learning' ) ); ?>" class="bdlms-user-dd__link bdlms-p-small active"><?php esc_html_e( 'My Learnings', 'bluedolphin-lms' ); ?></a>
