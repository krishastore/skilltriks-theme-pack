					...
					<form action="" method="post">
						...
						<div class="bdlms-keep-login bdlms-form-group">
							...
							<div class="bdlms-forgot-link">
								<a class="bdlms-link-text" href="<?php echo esc_url( wp_lostpassword_url( \BD\Lms\get_page_url( 'login' ) ) ); ?>" target="_blank"><?php esc_html_e( 'Forgot Password?', 'bluedolphin-lms' ); ?></a>
							</div>
						</div>
