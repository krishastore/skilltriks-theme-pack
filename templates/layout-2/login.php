	...
	<div class="stlms-login-wrap">
		<div class="stlms-login">
			<div class="stlms-login__header">
				...
				<div class="stlms-login__text"><?php esc_html_e( 'Hey, Welcome back!', 'skilltriks-theme-pack' ); ?><br>
					<?php esc_html_e( 'Please sign in to grow yourself', 'skilltriks-theme-pack' ); ?></div>
			</div>
					...
					<form action="" method="post">
						...
						<div class="stlms-keep-login stlms-form-group">
							...
							<div class="stlms-forgot-link">
								<a class="stlms-link-text" href="<?php echo esc_url( wp_lostpassword_url( \ST\Lms\get_page_url( 'login' ) ) ); ?>"
									target="_blank"><?php esc_html_e( 'Forgot Password?', 'skilltriks-theme-pack' ); ?></a>
							</div>
						</div>
						...
						?>
							<div class="stlms-form-footer">
								<button type="submit" class="stlms-btn stlms-btn-block">
									<?php esc_html_e( 'Log In', 'skilltriks-theme-pack' ); ?><span class="stlms-loader"></span></button>
								<?php if ( $auth_url ) : ?>
								...
								<div class="stlms-login-with-cta">
									...
									<path d="M9.43653 7.51992C8.17054 7.51992 7.00866 7.83225 5.95089 8.45692C4.89312 9.08159 4.0519 9.9228 3.42724 10.9806C2.80257 12.0383
										...
										8.17054 21.4375 9.43653 21.4375C10.7525 21.4375 11.9185 21.1502 12.9347 20.5755C13.9508 20.0008 14.7337 19.197 15.2834 18.1642C15.8331
										17.1315 16.108 15.9571 16.108 14.6411C16.108 14.0914 16.0747 13.7 16.008 13.4667H9.43653V15.8655H13.3844C13.3178 16.2819 13.1512 16.69
										12.8847 17.0898C12.5682 17.6062 12.1518 18.0143 11.6354 18.3142C11.019 18.6806 10.2861 18.8639 9.43653 18.8639C8.65362 18.8639 7.93317
										18.6681 7.27518 18.2767C6.6172 17.8852 6.09248 17.3522 5.70102 16.6775C5.30957 16.0029 5.11384 15.2658 5.11384 14.4662C5.11384 13.6666
										5.30957 12.9295 5.70102 12.2549C6.09248 11.5803 6.6172 11.0472 7.27518 10.6557C7.93317 10.2643 8.65362 10.0686 9.43653 10.0686C10.5359
										10.0686 11.4605 10.4267 12.2101 11.143L14.109 9.34395C12.8097 8.12793 11.2522 7.51992 9.43653 7.51992ZM20.3557
										11.4928V13.4667H18.3818V15.4657H20.3557V17.4396H22.3546V15.4657H24.3536V13.4667H22.3546V11.4928H20.3557Z" fill="white"/>
									</svg>
