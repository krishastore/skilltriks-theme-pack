	...
	<div class="stlms-login-wrap">
		<div class="stlms-login">
			<div class="stlms-login__header">
				<div class="stlms-login__title stlms-h2"><?php esc_html_e( 'Login to BlueDolphin', 'skilltriks-lms' ); ?></div>
					...
					<form action="" method="post">
						...
						<div class="stlms-keep-login stlms-form-group">
							...
							<div class="stlms-forgot-link">
								<a class="stlms-link-text" href="<?php echo esc_url( wp_lostpassword_url( \ST\Lms\get_page_url( 'login' ) ) ); ?>" target="_blank"><?php esc_html_e( 'Forgot Password?', 'skilltriks-lms' ); ?></a>
							</div>
						</div>
						...
						?>
							<div class="stlms-form-footer">
								<button type="submit" class="stlms-btn stlms-btn-block"><?php esc_html_e( 'Log In', 'skilltriks-lms' ); ?><span class="stlms-loader"></span></button>
								<?php if ( $auth_url ) : ?>
								<div class="stlms-login-with">
									<div class="stlms-hr"></div>
										<div class="stlms-or-text"><?php esc_html_e( 'or Log-in with', 'skilltriks-lms' ); ?></div>
									<div class="stlms-hr"></div>
								</div>
								<div class="stlms-login-with-cta">
									...
									<path d="M9.43653 7.51992C8.17054 7.51992 7.00866 7.83225 5.95089 8.45692C4.89312 9.08159 4.0519 9.9228 3.42724 10.9806C2.80257
										...
										<?php esc_html_e( 'Google', 'skilltriks-lms' ); ?>
									</a>
								</div>
								<?php endif; ?>
							</div>
